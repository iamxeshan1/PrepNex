            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <div className="flex flex-wrap items-center gap-4">
                   ...
                   <a href={socialLinks.socialYoutube || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#FF0000]/10 hover:text-[#FF0000] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                         <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.377.505 9.377.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                      </svg>
                   </a>
                   <a href={socialLinks.socialInstagram || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#E4405F]/10 hover:text-[#E4405F] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                   ...
                   <a href={socialLinks.socialFacebook || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#1877F2]/10 hover:text-[#1877F2] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                         <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                      </svg>
                   </a>
                   <a href={socialLinks.socialTelegram || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#24A1DE]/10 hover:text-[#24A1DE] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                   ...
                   <a href={socialLinks.socialWhatsapp || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#25D366]/10 hover:text-[#25D366] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                   ...
                   <a href={socialLinks.socialDiscord || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 hover:bg-[#5865F2]/10 hover:text-[#5865F2] transition-all cursor-pointer">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
