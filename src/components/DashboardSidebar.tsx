...
import { LayoutDashboard, BookOpenText, Book, BookOpen, BarChart3, HelpCircle, User, ShieldCheck, CreditCard, ExternalLink, MessageSquare, Bookmark, Trophy, Library } from 'lucide-react';
