          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              {agencies.filter(a => a.id !== 'All').slice(0, 8).map((agency, idx) => (
                <span key={idx} onClick={() => navigate(`/exams?agency=${encodeURIComponent(agency.id)}`)} className="bg-emerald-50/50 border border-emerald-100 text-[#006e5d] text-xs font-bold px-4 py-2 rounded-full hover:bg-[#006e5d] hover:text-white cursor-pointer transition-colors shadow-sm">
                  {agency.name}
                </span>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div className="flex items-start gap-10">
                 ...
                 <div>
                    <h3 className="text-2xl font-sans font-[800] text-slate-900 mb-3 tracking-tight">AI-Powered Question Bank & Mocks</h3>
                    <p className="text-slate-500 text-sm font-medium leading-[1.8] max-w-sm tracking-tight">Generate 50+ original questions in seconds with full detailed explanations and duplicate prevention.</p>
                 </div>
              </div>
              <div className="flex items-start gap-10">
                 <div className="w-16 h-16 bg-[#006e5d]/10 rounded-[1.5rem] flex items-center justify-center text-[#006e5d] shrink-0 transform hover:-rotate-6 transition-transform">
                 ...
                 <div>
                    <h3 className="text-2xl font-sans font-[800] text-slate-900 mb-3 tracking-tight">Verified Expert Authority</h3>
                    <p className="text-slate-500 text-sm font-medium leading-[1.8] max-w-sm tracking-tight">Designed for all competitive exams following NTA, JKSSB, SSC, and TCS examination standards.</p>
                 </div>
              </div>
           </div>
        </div>
