  ...
  return (
    <AdminLayout title="Coupons">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <StatCard title="Total Coupons" value={coupons.length} span="All time" colorClass="text-[#006e5d]" />
      ...
      {showAdd && (
        <form onSubmit={handleAdd} className="bg-white p-8 mb-8 relative border-b border-slate-200">
           ...
           <h3 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2"><Ticket className="w-5 h-5 text-[#006e5d]" /> Forge New Token</h3>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div>
               ...
               <input 
                 type="text" required 
                 className="w-full px-4 py-3 bg-slate-50 border border-slate-300 rounded-lg outline-none focus:ring-[#006e5d] focus:border-[#006e5d] uppercase font-bold text-[#002f26]"
           ...
           <div className="mt-8 flex items-center gap-6">
              <button type="submit" className="bg-[#006e5d] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#005a4d] transition-colors flex items-center gap-2">
                <Zap className="w-4 h-4" /> Create Coupon
              </button>
              <label className="flex items-center gap-3 cursor-pointer">
                 <input 
                   type="checkbox" 
                   className="w-5 h-5 rounded text-[#006e5d] focus:ring-[#006e5d] border-slate-300"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#002f26]/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl relative">
            ...
            <div className="p-4 overflow-y-auto flex-1">
               {loadingUsers ? (
                  <div className="py-12 flex justify-center"><Loader2 className="w-8 h-8 text-[#006e5d] animate-spin" /></div>
