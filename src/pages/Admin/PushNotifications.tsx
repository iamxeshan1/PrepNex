...
export default function PushNotifications() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Verify: Permanently clear this notification node from history?')) return;
    try {
            ...
            <form onSubmit={handleSend} className="space-y-6 relative">
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] outline-none focus:ring-4 focus:ring-indigo-500/5 font-bold shadow-inner"
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2.5rem] outline-none focus:ring-4 focus:ring-indigo-500/5 font-medium resize-none shadow-inner leading-relaxed"
              ...
              <div className="pt-6 border-t border-slate-50">
                 <button
                   ...
                   className="w-full py-5 bg-[#0f172a] text-white rounded-[2rem] font-black uppercase tracking-[0.3em] text-[10px] shadow-2xl hover:bg-black transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-4 disabled:opacity-50"
                 >
          ...
          <div className="bg-indigo-600 p-10 rounded-[3rem] text-white shadow-2xl shadow-indigo-100 relative overflow-hidden group">
             ...
             <div className="flex gap-6 relative">
                ...
                <div>
                   ...
                   <p className="text-sm font-medium text-indigo-100 leading-relaxed italic pr-4">Broadcasts are multi-channeled. Active entities receive priority toast hooks, while dormant nodes receive secondary browser pops-ups.</p>
                </div>
             </div>
          </div>
        </div>
        ...
        <div className="bg-white p-10 rounded-[4rem] border border-slate-100 shadow-sm min-h-[600px] flex flex-col">
          <header className="flex items-center justify-between mb-10 shrink-0 px-2">
            <div className="flex items-center gap-4">
              ...
              <div>
                 <h2 className="text-xl font-black text-slate-800 tracking-tight font-display uppercase">Dispatch Ledger</h2>
              ...
              {notifications.map((notif, idx) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-6 relative">
                    <div className="shrink-0 w-12 h-12 bg-white border border-slate-100 rounded-2xl flex items-center justify-center shadow-sm group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-6 pt-6 border-t border-slate-100">
                        ...
                        {notif.url && (
                          <div className="flex items-center gap-2 text-[8px] font-black text-indigo-400 uppercase tracking-widest truncate max-w-[150px]">
